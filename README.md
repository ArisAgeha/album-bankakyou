...
> ### 5.13 更新 版本 v1.4.2-beta

链接：https://pan.baidu.com/s/1WPNOi33DA6Hg7YNp_Yf71Q
提取码：6pup
...
- 请1.4.2版本的用户手动下载此版本更新
- 1.4.2版本由于BUG，检查更新的功能不正常，若不下载此版本会导致后续版本的检查更新功能失效

<br>

【BETA新功能】

- 目录树添加折叠所有目录按钮、同步文件夹最新状态的功能（在系统文件发生变化后使用）

<br>

【新功能】
1. 单页 / 对页模式下，可以使用【*】键锁定图片的缩放比例，使用【/】键锁定图片的位置，锁定后在换页时不会复原了
2. 单页/对页模式下，翻页时，添加了首页/末页的提示 

【BUG修复】
1. 对页模式在图片较小时，现在左图会靠右，右图会靠左，不会出现两张图片中间留出空白的情况了
2. 一些小的UI修复
